...
def affiche_notice(nom_regle, bouton_notice):
    ...
    Créé un bouton pour cacher la regle

    Parameters
    ----------
    nom_regle : str
        Nom de la combinaison en cours.
    bouton_notice : tkinter.Button
        Bouton permettant d'afficher la notice.
...
def notice(nom_regle):
    """
    Genere la notice de la combinaison
