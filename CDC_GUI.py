...
class Inscription_des_joueurs(tk.LabelFrame):
    ...
    def __init__(self, master):
        ...
        # self.bouton_ajouter.place(x=400, y=120)
...
class Regles_CDC(tk.LabelFrame):
    ...
    def __init__(self, master=None):
        ...
        ######
        dict_var = am.give_the_rules(self, Root.Joueurs_obj, chouette_1, chouette_2, cul)
        ...
        if not dict_var['event']:
            ...
            bouton_joueur_suivant = tk.Button(self, text='Joueur suivant', state='disabled', command=lambda: Game(self))
